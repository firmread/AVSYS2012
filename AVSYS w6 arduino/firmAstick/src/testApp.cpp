...
void testApp::update(){
	...
	updateArduino();
    lowFreq             =   ofMap(ard.getAnalog(0), 0, 1024, 50, 200) ;
	highFreq            =   ofMap(ard.getAnalog(1), 0 , 1024, 100, 700) ;
    
    fm_positionAdder	=   (ofMap(ard.getAnalog(2),0,1024,0.01,10) / 44100.0) * TWO_PI;
    
    am_frequency        =   (ofMap(ard.getAnalog(3), 0, 1024, .01, 100));
